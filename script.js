...
const client_id = "ASSgtxgb69EY4fG2kMgwuvmuu82-5q9w9oj_4x-7jsJy7uO70Rt-alxWqAFsOIU5qRDHW3NKjUw7GL0i";
const currency = "USD";
    ...
    let paypal_buttons = paypal.Buttons({ // https://developer.paypal.com/sdk/js/reference
        ...
        onApprove: function(data, actions) {
            ...
            .then((order_details) => {
                ...
                alerts.innerHTML = `<div class=\'ms-alert ms-action\'>Thank you ` + order_details.payer.name.given_name + ` ` + order_details.payer.name.surname + ` for booking a paid appointment of ` + order_details.purchase_units[0].payments[intent_object][0].amount.value + ` ` + order_details.purchase_units[0].payments[intent_object][0].amount.currency_code + `! Check your email for appointment details.</div>`;
